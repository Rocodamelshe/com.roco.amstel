...
class Amstel extends Homey.App {	
	onInit() {
		this.log('Amstel starting');
		
		triggercard = new Homey.FlowCardTrigger('new_Amstel_pic');
		...
		tokenval = new Homey.FlowToken( 'Amstel', {
				type: 'string',
				title: 'Amstel'
			});
		tokenval.register()
				.then(() => {
				return tokenval.setValue( "https://i.pinimg.com/236x/5b/3d/7b/5b3d7be42d2c8917e17e8a03eaf1a4ff--Amstel-tilia.jpg" );
				})
		
		//const rssurl = "https://www.pinterest.co.uk/stof3/Amstel-tilia.rss/";
		//const rssurl = "https://backend.deviantart.com/rss.xml?q=gallery%3AAmstelTilia%2F7290048&type=deviation";
		//const rssurl = "https://nl.pinterest.com/elturix80/Amstel-tilia.rss/";
		const rssurl = "https://nl.pinterest.com/edubelaar/amstel-bier.rss/";
